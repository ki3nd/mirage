...
from mirage.commands.builtin.mem0._provision import metadata_provision
...
@command("find", resource="mem0", spec=SPECS["find"], provision=find_provision)
async def find(
    accessor: Mem0Accessor,
    paths: list[PathSpec],
    *texts: str,
    ...
    **_extra: object,
    ...
    search_resource = p0.resource_path if p0 else ""
